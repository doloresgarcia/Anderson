...
% imports from neurips paper
%\newcommand{L-GATr}{L-GATr\xspace}
\newcommand{\bftab}[1]{{\fontseries{b}\selectfont #1}}
\newcommand{\dz}{\phantom{0}}
\newcommand{\result}[2]{{#1}~\textcolor{error}{$\pm$ {#2}}}
\newcommand{\bestresult}[2]{{\bftab{#1}}~\textcolor{error}{$\pm$ {#2}}}
\definecolor{error}{rgb}{0.7, 0.7, 0.7}
...
\newcommand{\psimr}{p_\text{sim}}
\newcommand{\psimp}{p_\text{gen}}
\newcommand{\pmd}{p_\text{model}}
\newcommand{\punf}{p_\text{unfold}}
\newcommand{\pdr}{p_\text{data}^\text{reco}}
\newcommand{\pdp}{p_\text{data}^\text{part}}
\newcommand{\pmdr}{p_\text{sim}^\text{reco}}
\newcommand{\pmdp}{p_\text{sim}^\text{part}}
