...
\hypersetup{
	pdftitle={A Lorentz-Equivariant Transformer for All of the LHC},
	pdfauthor={Brehmer et al.},
...
\setitemize{itemsep=2pt, parsep=0pt} 				% adjust itemize environment
\setenumerate{itemsep=2pt, parsep=0pt} 				% adjust enumerate environment
...
\definecolor{gatrgreen}{HTML}{419108}
\definecolor{gatrred}{HTML}{E06E52}
\definecolor{gatrblue}{HTML}{726C93}
\definecolor{gatrgrey}{HTML}{EDEDED}

\definecolor{errorcol}{HTML}{CC0000}
\newcommand{\errnote}[2]{\textcolor{errorcol}{#2}{\marginpar{\raggedright\footnotesize\textcolor{errorcol}{#1}}}}

\tikzstyle{arrow} = [-{Latex[scale=1]}]
\tikzstyle{arrow2} = [-{Latex[scale=0.5]}]